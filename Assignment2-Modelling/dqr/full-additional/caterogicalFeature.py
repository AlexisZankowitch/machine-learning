...
data = pd.read_csv('../../data/bank/bank-additional-full-2.csv').select_dtypes(include=[object])
...
#storage
df.to_csv('../../data/dqr/gouhier-zankowitch-DQR-CategoricalFeatures-full-additional.csv')
